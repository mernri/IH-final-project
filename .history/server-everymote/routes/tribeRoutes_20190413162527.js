...
// DELETE route => to delete a user from a tribe
// NE RETIRE PAS LE USER DE LA TRIBE
    ...
    .then(workspaceId => {
      Tribe.findOneAndUpdate(
        ...
        .then(theTribe => {
          ...
          console.log("theTribe._id", theTribe._id)

          User.findByIdAndUpdate({ _id: userId }, { tribe: theTribe._id });
          res.json("Ok");
        })
        .catch(err => {
          res.json(err);
