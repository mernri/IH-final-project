...
// GET Route - To check if onboarding complete

authRoutes.get("/profile", (req, res, next) => {
  const fullname = req.body.picture;
...
// // Get route - Retrieve a specific user 
...
//   authRoutes.findById(req.params.id)
//     .then(response => {
//       res.status(200).json(response);
//       console.log("hello from authroutes side")
//     })
//     .catch(err => {
//       res.json(err);
//     });
