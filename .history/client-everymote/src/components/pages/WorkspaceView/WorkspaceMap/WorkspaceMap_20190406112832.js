...
class WorkspaceMap extends React.Component {
  ...
  getCityCoordinates = async (this.props.workspace.city) => {
    const APIKEY = "yPCdzT6YO4vPW3vyeCEctUZ71KsASll6";
    const url = `http://open.mapquestapi.com/geocoding/v1/address?key=${APIKEY}&location=${this.props.workspace.city}`;
    let response = {};
    let latitude;
    let longitude;
