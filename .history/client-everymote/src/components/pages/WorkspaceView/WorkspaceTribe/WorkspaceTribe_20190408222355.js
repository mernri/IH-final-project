...
class WorkspaceTribe extends Component {
  ...
  getOneUser = () => {
    axios.get("http://localhost:5000/api/user/5cab9cb1e71a1942074804f5").then(response => {
      console.log("hello, i'm the only user in the tribe", response.data)
    })
  }

    // Tentative pour récupérer les users avec un .populate... Echec 
  // getTribeUser = () => {
  //    axios
  //     .get(
  //       `http://localhost:5000/api/tribe/5caba1bce00b9945986ecf98`
  //     ).then(reponse => {
  //       console.log("the cool users are : ", reponse)
  //     })
  // }
