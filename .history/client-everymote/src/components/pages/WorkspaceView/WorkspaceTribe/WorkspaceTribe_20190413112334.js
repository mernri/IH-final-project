...
class WorkspaceTribe extends Component {
  ...
  render() {
    ...
    console.log("tribe members", this.props.members)
    console.log("is loggedin user in tirbe ?", this.isUserInTribe())
    ...
    return (
      <div>
        ...
        <div className="join-tribe-button">
          {(this.props.user && this.props.members && this.isUserInTribe() === false) ? (
            <div
              className="button"
              onClick={() => {
                this.joinTheTribe();
