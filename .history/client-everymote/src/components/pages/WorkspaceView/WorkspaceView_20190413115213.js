      ...
      <div className="workspace-container">
        ...
        <section className="section workspace-content">
          ...
          <section className="section workspace-tribe text-left" id="tribe">
            ...
            {
              (this.state._id && this.state.users && this.props.user) ?
              <WorkspaceTribe workspaceId={this.state._id} members={this.state.users} user={this.props.user} />
              :
              <div> GROS SOUCI LÀ </div>
            }
          </section>
